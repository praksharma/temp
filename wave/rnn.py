...
from modulus.variables import Variables, _length_key_list
from modulus.tf_utils.activation_functions import set_nonlinearity
from modulus.tf_utils.layers import fc_layer, _variable
...
class RNNArch(Arch):
  ...
  def _network_template(self, invars, output_keys):
